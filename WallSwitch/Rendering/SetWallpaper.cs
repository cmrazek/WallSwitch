...
namespace WallSwitch
{
	...
	{
		#region Variables
		private WallpaperRenderer _renderer = null;
		#endregion
		...
		public void Set(Database db, Theme theme, SwitchDir dir, bool forceQuick, ref int randomGroupCounter, CancellationToken cancel)
		{
						...
						foreach (var imgLayout in files)
						{
							...
							else
							{
								...
								if (!spanRect.IsEmpty)
								{
									...
									{
										_renderer.RenderFullScreenImageOnScreen(imgLayout.ImageRec, spanRect);
									}
								}
							}
						}
